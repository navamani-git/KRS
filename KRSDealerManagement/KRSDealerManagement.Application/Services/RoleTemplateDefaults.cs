        ...
        public static IReadOnlyDictionary<string, MenuAccessLevel> GetDefaultMenus(string? templateCode)
        {
            ...
            return templateCode.ToUpperInvariant() switch
            {
                RoleTemplateCodes.Manager => new Dictionary<string, MenuAccessLevel>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    [StaffMenuAccess.BookingPaperReceived] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingInvoiced] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingInsuranceCreated] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingRtoRequested] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingSubsidyIdPending] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingSubsidyDocsPending] = MenuAccessLevel.Full,
                    [StaffMenuAccess.BookingRegistered] = MenuAccessLevel.Full,
