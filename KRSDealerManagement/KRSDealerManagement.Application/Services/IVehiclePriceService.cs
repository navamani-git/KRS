...
namespace KRSDealerManagement.Application.Services
{
    public interface IVehiclePriceService
    {
        ...
        Task<string?> ValidatePriceForVehicleCreateAsync(int modelId, int colorId, DateTime asOfDate);
        Task<InvoicePriceChangePreviewDto> GetInvoicePriceChangePreviewAsync(int vehicleId, DateTime invoiceDate);
